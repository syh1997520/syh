...
public class ProductDao extends BaseDao<Product>{
	...
	public List<Product> selectPopularProduct(){
		String sql="select * from product where proStatic='在售' order by rand() limit 10";
	...
	public List<Product> selectProductByProName(String proName){
		String name="%"+proName+"%";
		String sql = "select * from product where proName like ? and proStatic='在售'";
	...
	public List<Product> selectProductByProNamePriceLow(String proName){
		String name="%"+proName+"%";
		String sql = "select * from product where proName like ? and proStatic='在售' order by proPrice desc";
		return this.selectAll(sql,name);
	}
	 ...
	 * @return
	 */
	public int productreup(int proId){
		String sql="update product set proStatic='在售' where proId=?";
		return this.updateOne(sql, proId);
	}
