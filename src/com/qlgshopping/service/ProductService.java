...
public class ProductService {
	...
	public Product selectProductByProNameStoId(String proName,int stoId){
		...
		return pDao.selectProductByProNameStoId(proName, stoId);
	}
	
	/**
	 * 获取热门产品
	 */
	public ArrayList<Product> selectPopularPro() {
         ArrayList<Product> selectProductByProName = new ArrayList<Product>(pDao.selectPopularProduct());
	...
	public Page<Product> getPageA(int currentPage,int pageSize){
		...
		//获取总笔数
		int totalRow=(int) pDao.getTableSizeA();
		page.setTotalRow(totalRow);
		
		//获取集合
		int start=(page.getCurrentPage()-1)*page.getPageSize();
		ArrayList<Product> aList=pDao.selectAlllByPageA(start, pageSize);
	 ...
	 * @return
	 */
	public boolean buyProduct(int proId,int buyNumber){
		if(pDao.buyProduct(proId,buyNumber)>0){
			return true;
		}
		return false;
	}
	 ...
	 * @return
	 */
	public boolean productUpload(int proid) {
		if(pDao.productreup(proid) >0){
			return true;
		}
		return false;
	}
	 ...
	 * @return
	 */
	public ArrayList<Product> selectProductByPronamePriceLow(String proName){
		ArrayList<Product> selectProductByProName = new ArrayList<Product>(pDao.selectProductByProNamePriceLow(proName));
 	     for(Product pro:selectProductByProName){
 	    	 this.loadProductForeign(pro);
 	     }
 	     return selectProductByProName;
	 ...
	 * @return
	 */
	public ArrayList<Product> selectProductByProNamePriceHigh(String proName){
		ArrayList<Product> selectProductByProName = new ArrayList<Product>(pDao.selectProductByProNamePriceHigh(proName));
 	     for(Product pro:selectProductByProName){
 	    	 this.loadProductForeign(pro);
 	     }
 	     return selectProductByProName;
	 ...
	 * @return
	 */
	public ArrayList<Product> selectProductByProNameDataLow(String proName){
		ArrayList<Product> selectProductByProName = new ArrayList<Product>(pDao.selectProductByProNameDateLow(proName));
 	     for(Product pro:selectProductByProName){
 	    	 this.loadProductForeign(pro);
 	     }
 	     return selectProductByProName;
	 ...
	 * @return
	 */
	public ArrayList<Product> selectProductByProNameSalesLow(String proName){
		ArrayList<Product> selectProductByProName = new ArrayList<Product>(pDao.selectProductByProNameSalesLow(proName));
 	     for(Product pro:selectProductByProName){
 	    	 this.loadProductForeign(pro);
 	     }
 	     return selectProductByProName;
