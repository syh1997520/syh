...
function getPageData(data,status,xhr){
         ...
         $.each($(oList),function(index,element){
              	var obj='<tr>';
              		...
              		obj+='<td><a onclick="return confirm(\'是否删除？\')" href="shopServlet?op=delOrd&ordId='+element.ordId+'" class="btn button_btn btn-danger" id="del"><i class="fa fa-trash-o"></i>&nbsp;删除</a></td>';
              		obj+='</tr>';
              	$("#tBody").append(obj);
              });
             $("#ulpage").empty();
