  ...
  <div class="Sellerber_header apex clearfix" id="Sellerber_header">
   ...
   <div class="news l_f"><a href="#" class="fa  fa-bell "></a><em>5</em></div>
     <div class="administrator l_f">
       <img src="images/avatar.png"  width="36px"/><span class="user-info">欢迎你,${business.busName}</span><i class="glyph-icon fa  fa-caret-down"></i>
...
<!--左侧-->
  <div class="Sellerber_left menu" id="menuBar">
    ...
    <dl class="nav nav-list" id="menu_list">
     ...
     <dd class="submenu">
       <ul>
         <li class="home"><a href="javascript:void(0)" name="businessServlet?op=querySto" title="产品类表" class="iframeurl"><i class="fa fa-angle-double-right"></i>产品管理</a></li>
    ...
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="busstore.jsp" title="店铺列表" class="iframeurl"><i class="fa fa-angle-double-right"></i>店铺列表</a></li>
