  ...
  <div class="Sellerber_header apex clearfix" id="Sellerber_header">
   ...
   <div class="news l_f"><a href="#" class="fa  fa-bell "></a><em>5</em></div>
     <div class="administrator l_f">
       <img src="images/avatar.png"  width="36px"/><span class="user-info">欢迎你,${admin.admName }</span><i class="glyph-icon fa  fa-caret-down"></i>
...
<!--左侧-->
  <div class="Sellerber_left menu" id="menuBar">
    ...
    <dl class="nav nav-list" id="menu_list">
     <dt class="shop_index nav_link " ><a href="javascript:void(0)" name="index.html" class="iframeurl" title=""><i class="fa fa-home"></i><span class="menu-text">店铺首页</span></a></dt>
     ...
     <dd class="submenu">
       <ul>
         <li class="home"><a href="javascript:void(0)" name="adminproduct.jsp" title="产品类表" class="iframeurl"><i class="fa fa-angle-double-right"></i>产品管理</a></li>
    ...
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="adminstore.jsp" title="产品类表" class="iframeurl"><i class="fa fa-angle-double-right"></i>店铺列表</a></li>
    ...
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="adminunspeakAble.jsp" title="权限设置" class="iframeurl"><i class="fa fa-angle-double-right"></i>禁言用户</a></li>
       <li class="home"><a href="javascript:void(0)" name="administrator_list.jsp" title="管理员列表" class="iframeurl"><i class="fa fa-angle-double-right"></i>正常用户</a></li>
