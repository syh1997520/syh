	...
	<div class="login-page">
		<div class="container"> 
			...
			<div class="login-body">
				<form action="userInfoServlet?r=login" method="post">
					<input type="text" class="user" name="username" placeholder="账号" required="">
					<input type="password" name="password" class="lock" placeholder="密码" required="">
					<span style="color:red">${loginMsg}</span>
					<input type="submit" value="登录">
					<div class="forgot-grid">
						<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>请记住我</label>
						<div class="forgot">
			...
			<h6> 没有账号? <a href="signup.jsp">点我注册 »</a> </h6> 
